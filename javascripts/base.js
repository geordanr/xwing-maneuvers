...
(function() {
  var DISPLAY_MODES, exportObj;

  exportObj = typeof exports !== "undefined" && exports !== null ? exports : this;

  DISPLAY_MODES = ['NOTHING', 'FRONT_ARC', 'RANGE_BAND'];
  ...
  exportObj.Base = (function() {
    function Base(args) {
      ...
      this.front_firing_arc = null;
      this.rear_firing_arc = null;
      ...
      this.group.on('dblclick', function(e) {
        _this.getRangeBand().hide();
        _this.getFrontFiringArc().hide();
        _this.display_mode = (_this.display_mode + 1) % DISPLAY_MODES.length;
        switch (DISPLAY_MODES[_this.display_mode]) {
          case 'FRONT_ARC':
            return _this.getFrontFiringArc().show();
          case 'RANGE_BAND':
            return _this.getRangeBand().show();
        }
      });
    }
    ...
    Base.prototype.destroy = function() {
      ...
      if (this.front_firing_arc != null) {
        this.front_firing_arc.destroy();
      }
      if (this.rear_firing_arc != null) {
        this.rear_firing_arc.destroy();
      }
    ...
    Base.prototype.getFrontFiringArc = function(args) {
      if (this.front_firing_arc == null) {
        this.front_firing_arc = new exportObj.FiringArc({
          base: this
        });
      }
      return this.front_firing_arc;
    };
