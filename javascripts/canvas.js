...
(function() {
  ...
  exportObj.transformToCenterAndHeading = function(ctx, center_x, center_y, heading_radians) {
    ctx.translate(center_x, center_y);
    return ctx.rotate(heading_radians);
  };

  exportObj.translateToNubsFromCenter = function(ctx, size) {
    var x_offset;
    switch (size) {
      case 'small':
    ...
    return ctx.translate(x_offset, 0);
  };
